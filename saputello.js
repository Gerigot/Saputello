...
const frase = (getRandomArrayElement(frase_a) + getRandomArrayElement(frase_b) + getRandomArrayElement(frase_c) + getRandomArrayElement(frase_d) + getRandomArrayElement(frase_e) + getRandomArrayElement(frase_f) + getRandomArrayElement(frase_g))
console.log(frase);
